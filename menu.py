...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainmenu_widget.setStyleSheet("QWidget#mainmenu_widget{\n"
"background-color: qlineargradient(spread:pad, x1:0.095, y1:0.130545, x2:0.965, y2:0.938, stop:0 rgba(170, 85, 127, 255), stop:1 rgba(255, 255, 0, 255));}")
        ...
        self.mainmenu_label.setGeometry(QtCore.QRect(290, 40, 231, 54))
        self.mainmenu_label.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.mainmenu_label.setStyleSheet("font: 20pt \"Felix Titling\";color :rgb(0, 0, 127)")
...
"color: rgb(0, 0, 127);\n"
"font: 8pt \"Felix Titling\";")
        self.playbutton.setObjectName("playbutton")
        self.username_label = QtWidgets.QLabel(self.mainmenu_widget)
        self.username_label.setGeometry(QtCore.QRect(320, 110, 181, 31))
        self.username_label.setStyleSheet("font: 10pt \"Felix Titling\";color : rgb(255, 255, 255)")
        ...
        self.quitbutton.setStyleSheet("border-radius:20px;background-color:rgb(255, 255, 255) ;\n"
"color: rgb(0, 0, 127);\n"
"font: 8pt \"Felix Titling\";")
        self.quitbutton.setObjectName("quitbutton")
        self.progress_progressBar = QtWidgets.QProgressBar(self.mainmenu_widget)
        self.progress_progressBar.setGeometry(QtCore.QRect(360, 220, 118, 23))
        ...
        self.level_label.setStyleSheet("border-radius:20px;background-color:rgb(255, 255, 255) ;\n"
"color: rgb(0, 0, 127);\n"
"font: 8pt \"Felix Titling\";")
